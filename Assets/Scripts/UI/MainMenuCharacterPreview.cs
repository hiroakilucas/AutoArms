...
public class MainMenuCharacterPreview : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        currentCharacter.transform.position = new Vector3(0, -2, 0); // Ajuste conforme sua c�mera
        Camera.main.orthographicSize = 5; // Garantir visibilidade
        // Remove componentes que n�o queremos rodando no menu
        ...
        // For�a anima��o idle, se houver Animator
