...
public static class SkillAssetGenerator
{
    ...
    private static readonly SkillDef[] Defs = new SkillDef[]
    {
        ...
        new SkillDef { fileName = "skill_extra_thick_skin",   skillName = "Extra Thick Skin",     description = "+50% armor (redução de dano)",                               category = SkillCategory.DefensePassive, activationType = SkillActivationType.Passive, usesPerFight = 1 },
