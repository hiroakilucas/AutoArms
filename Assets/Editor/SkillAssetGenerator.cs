...
public static class SkillAssetGenerator
{
    ...
    private static readonly SkillDef[] Defs = new SkillDef[]
    {
        ...
        new SkillDef { fileName = "skill_saboteur",           skillName = "Saboteur",             description = "A 1ª arma que o oponente puxar na luta quebra com 100% de certeza", category = SkillCategory.CombatPassive,  activationType = SkillActivationType.Passive, usesPerFight = 1 },
        ...
        // DefensePassive
        new SkillDef { fileName = "skill_shield",             skillName = "Shield",               description = "+45% block rate, -25% dano causado (penalidade do escudo)", category = SkillCategory.DefensePassive, activationType = SkillActivationType.Passive, usesPerFight = 1 },
        ...
        new SkillDef { fileName = "skill_lead_skeleton",      skillName = "Lead Skeleton",        description = "-15% dano de armas Heavy",                                  category = SkillCategory.DefensePassive, activationType = SkillActivationType.Passive, usesPerFight = 1 },
        ...
        new SkillDef { fileName = "skill_ballet_shoes",       skillName = "Ballet Shoes",         description = "+10% evasion, primeiro golpe automaticamente esquivado",     category = SkillCategory.DefensePassive, activationType = SkillActivationType.Passive, usesPerFight = 1 },
        ...
        new SkillDef { fileName = "skill_repulse",            skillName = "Repulse",              description = "30% de chance de deflectir o throw do oponente de volta para ele; o deflect tem +5% crítico adicional", category = SkillCategory.DefensePassive, activationType = SkillActivationType.Passive, usesPerFight = 1 },
        ...
        new SkillDef { fileName = "skill_bodybuilder",        skillName = "Bodybuilder",          description = "+10% evasion e +40% hit speed, só com arma Heavy",           category = SkillCategory.WeaponPassive,  activationType = SkillActivationType.Passive, usesPerFight = 1 },
        ...
        new SkillDef { fileName = "skill_garimpeiro",         skillName = "Garimpeiro",           description = "40% de chance no início do turno (desarmado) de pegar uma arma aleatória do chão em vez do loadout", category = SkillCategory.WeaponPassive,  activationType = SkillActivationType.Passive, usesPerFight = 1 },
        ...
        new SkillDef { fileName = "skill_mimic",              skillName = "Mimic",                description = "Copia e usa a última skill ativa (Super) que o oponente usou nesta luta; não consome o turno (1x por luta)", category = SkillCategory.Super,          activationType = SkillActivationType.Active,  usesPerFight = 1 },
        new SkillDef { fileName = "skill_magneto",            skillName = "Magneto",              description = "Levita todas as armas do chão para as costas apontadas ao inimigo, depois solta tudo de uma vez — cada arma causa seu dano (weaponDmg + STR), sempre acerta (1x por luta)", category = SkillCategory.Super, activationType = SkillActivationType.Active, usesPerFight = 1 },
